...
from alienrecon.core.exceptions import SecurityError, ValidationError
from alienrecon.core.input_validator import InputValidator
from alienrecon.tools.base import _validate_command_security
...
class TestSecurityValidation:
    ...
    def test_url_validation(self):
        ...
        assert (
            InputValidator.validate_url("https://sub.example.com:8080/path")
