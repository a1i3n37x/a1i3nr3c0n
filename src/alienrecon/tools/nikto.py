...
class NiktoTool(CommandTool):
    ...
    def build_command(self, **kwargs: Any) -> list[str]:
        ...
        port = kwargs["port"]
        nikto_arguments = kwargs.get("nikto_arguments", None)
        temp_json_output_path = kwargs.get("temp_json_output_path", None)
        if not target:
